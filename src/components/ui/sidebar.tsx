...
import { useIsMobile } from "@/lib/state/is-mobile";
import { sidebarOpenAtom, sidebarOpenMobileAtom } from "@/lib/state/sidebar";
...
function SidebarProvider({
	...
	React.useEffect(() => {
		if (!initialized.current) {
			...
			setAtomOpen(defaultOpen);
		}
	}, [defaultOpen, setAtomOpen]);
